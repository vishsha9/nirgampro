...
double ptm_para::getR(ptm_para *p){
	double r;
...
double ptm_para::getCcTop(ptm_para *p){
	double cc;
...
double ptm_para::getCgTop(ptm_para *p){
	double cg;
...
double ptm_para::getCcLocal(ptm_para *p){
	double cc;
	double k = p->K, t = p->t, h = p->h, s = p->s, w = p->w, l = p->length;
...
double ptm_para::getCgLocal(ptm_para *p){
	double cg;
	double w = p->w, h = p->h, s = p->s, t = p->t, k = p->K, l = p->length;
