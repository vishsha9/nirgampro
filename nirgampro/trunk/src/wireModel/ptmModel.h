#ifndef __PTM_MODEL__
#define  __PTM_MODEL__
...
struct ptmModel: public baseWireModel{
	PTM_LAYER layer;
	double w;//
	double s;//
	double length;
	...
	double getR(ptmModel *para);

	double getCgTop(ptmModel *para);
	double getCcTop(ptmModel *para);

	double getCgLocal(ptmModel *para);
	double getCcLocal(ptmModel *para);
